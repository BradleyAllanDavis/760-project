...
import sys
import os
import capsulesLandmark as net
            ...
            for chunk_id in chunk_ids:
                ...
                for step in range(num_batches_per_chunk + 1):
                    ...
                    try:
                        ...
                        logger.info('{} out of {} batches in chunk {}, epoch {}. finished in {}. loss={}'.format(step,num_batches_per_chunk+1,chunk_id,epoch,time.time()-tic,loss_value))
